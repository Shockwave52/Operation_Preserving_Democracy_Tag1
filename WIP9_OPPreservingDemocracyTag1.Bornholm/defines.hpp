...
#define FontTDC       "PuristaMedium"

class tdc_gui_backgroundBase {
  type = CT_STATIC;
  idc = -1;
  style = ST_PICTURE;
...
class tdc_gui_buttonBase {
  ...
  */
  ...
  textureNoShortcut = "";
  animTextureNormal = "\tdc_gui\data\buttonNormal_gradient_top.paa";
  animTextureDisabled = "\tdc_gui\data\buttonDisabled_gradient.paa";
  animTextureOver = "\tdc_gui\data\buttonNormal_gradient_top.paa";
  animTextureFocused = "\tdc_gui\data\buttonNormal_gradient_top.paa";
  animTexturePressed = "\tdc_gui\data\buttonNormal_gradient_top.paa";
  animTextureDefault = "\tdc_gui\data\buttonNormal_gradient_top.paa";
  period = 0.5;
  font = FontTDC;
...
class RscListBox;
class tdc_gui_listBoxBase : RscListBox{
  type = CT_LISTBOX;
  style = ST_MULTI;
  font = FontTDC;
  sizeEx = 0.03921;
...
class RscCombo;
class tdc_gui_comboBoxBase: RscCombo {
 idc = -1;
 type = 4;
 style = "0x10 + 0x200";
 x = 0;

...
"Laut dänischen Angaben sind die BIS nur leicht bewaffnet und sind meist in Civil-Kleidung unterwegs. Allerdings besteht die Möglichkeit das sie nach dem Angriff auf den Außenposten in besitzt von Schultergestützten Waffen und schweren MG's gekommen sind. Zusätzlich gelten die Städte <marker name=""aakirkeby"">Aakirkeby</marker>, <marker name=""vestermarie"">Vestermarie</marker> und <marker name=""klemensker"">Klemensker</marker> als Rebellenzentren .<br />
...
Bereitschaft beginnt um 10:00. Der Patrouillenflug startet um 10:02 und fliegt entlang der auf der Karte markierten Wegpunkte <marker name=""wp1"">HeliWP1</marker>, <marker name=""wp2"">HeliWP2</marker>, <marker name=""wp3"">HeliWP3</marker>, <marker name=""wp4"">HeliWP4</marker>, <marker name=""wp5"">HeliWP5</marker> und <marker name=""wp6"">HeliWP6</marker>. Genutzt wird eine 'Westland Lynx' Rufzeichen 'Eagle'. 'Eagle' wird mit der QRF, Rufzeichen 'Weasel', auf dem Kanal 1 des 'PRC-117f'  in Verbindung bleiben und Statuspdates sowie Situationreports geben.<br />
...
Die <marker name=""Logistik"">Logistik</marker> war so nett und hat für die QRF und die Piloten bereits jeweils eine Kiste zum ausrüsten ins Logistikzentrum gestellt. Sonderwünschen müssen am Logistiktresen bestellt werden."
]];

player createDiaryRecord ["Diary",["Szenario",
"Schon seit einiger Zeit kämpfen Rebellen für die Unabhängigkeit von Bornholm. Sie nennen sich selbst das 'Bornholm Independence Syndicate' oder kurz BIS. Die Bewegung stößt innerhalb der Bevölkerung auf Missverständnis und die Mehrheit ist gegen eine Unabhängigkeit. Nachdem die Diplomatie gescheitert ist, haben die BIS einen Dänischen Außenposten angegriffen und ausgeraubt. Mit weiterer Gewalt ist also zu rechnen, weshalb die dänische Regierung die NATO um Hilfe gebeten hat. So entstand 'Operation 'Preserving Democracy''. Die jeweiligen Delegationen von Deutschland, England und der USA werden auf dem <marker name=""Basis"">Flughafen von Roenne</marker> stationiert, der von der dänischen Armee zur Verfügung gestellt wurde. Die Bundeswehr ist die erste Delegation die am Roenne Flughafen ankommt."
]];

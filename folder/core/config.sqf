...
//Mission specific variables (Shockwave's Mission = SWM)
SWM_debugTrackAIUnits = true; //tracks spawned AIunits via markers for DEBUG purpose

SWM_HeliHit = false;
publicVariable "SWM_HeliHit";

SWM_pilotsIdentified = false;
publicVariable "SWM_pilotsIdentified";

SWM_heliDestroyed = false;
publicVariable "SWM_heliDestroyed";

SWM_aiSkill = ((paramsArray select 0)/10);
SWM_samLocs = ["sam1", "sam2", "sam3"];

SWM_aiSpawnsSam1 = ["sam1aispawn1", "sam1aispawn2", "sam1aispawn3", "wp2"];
SWM_aiSpawnsSam2 = ["sam2aispawn1", "sam2aispawn2", "sam2aispawn2", "wp3"];
SWM_aiSpawnsSam3 = ["sam3aispawn1", "sam3aispawn2", "sam3aispawn3", "sam3aispawn4"];
